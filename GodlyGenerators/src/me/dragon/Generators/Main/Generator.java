...
public class Generator implements Serializable {
    ...
    public void openupgradegui(Main plugin, Player p) {
        ...
        genmeta.setLore(Arrays.asList(Utils.GenMessage("&bLevel: " + this.level),
                Utils.GenMessage("&bTime: " + (this.level < 2 ? "2" : "1") + " second(s)"),
                Utils.GenMessage("&bAmount dropped: " + (1 +(int)(level - 1)))));
        ...
        upgrademeta.setLore(Arrays.asList(Utils.GenMessage("&bNext Level: " + (this.level + 1)),
                Utils.GenMessage("&bTime: " + (this.level + 1 > 2 ? "1" : "2") + " second(s)"),
                Utils.GenMessage("&bAmount dropped: " + (1 +(int)(level + 1 - 1))),
